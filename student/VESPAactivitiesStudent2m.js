...
(function() {
    ...
    class ActivityRenderer {
                            ...
                            ${hasSlides ? `
                                <div class="media-panel active" id="slides-panel">
                                    <div class="responsive-embed">
                                        <iframe src="${slidesSrc}" allowfullscreen style="width: 100%; height: 100%; border: none;"></iframe>
                                    </div>
                                </div>
                            ` : ''}
                            ${hasVideo ? `
                                <div class="media-panel ${!hasSlides ? 'active' : ''}" id="video-panel">
                                    <div class="responsive-embed">
                                        <iframe src="${videoSrc}" allowfullscreen style="width: 100%; height: 100%; border: none;"></iframe>
                                    </div>
                                </div>
                            ` : ''}
                            ${hasBackgroundInfo ? `
        ...
        async handleExit() {
            ...
            // No need to restore iframes since we're no longer moving them
