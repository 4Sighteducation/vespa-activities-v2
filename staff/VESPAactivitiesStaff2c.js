...
(function() {
    ...
    const CONFIG = {
        ...
        views: {
            container: 'view_3168', // Rich text view for UI injection (updated)
            // Data views on page (kept for reference)
            vespaResults: 'view_3164',
            studentRecords: 'view_3165',
            activities: 'view_3166',
            answers: 'view_3167'
        }
    };
    ...
    class VESPAStaffManager {
        ...
        async loadActivitiesFromJSON() {
            ...
            try {
                ...
                const externalPaths = [
                    ...
                    'https://cdn.jsdelivr.net/gh/4Sighteducation/vespa-activities-v2@main/shared/utils/activitiesjsonwithfields1b.json',
        ...
        async loadActivities() {
            ...
            try {
                ...
                const possibleViewIds = [CONFIG.views.activities, 'view_3166'];
                let viewData = $();
        ...
        render() {
            ...
            if (!document.getElementById('vespa-staff-styles')) {
                ...
                styleLink.href = 'https://cdn.jsdelivr.net/gh/4Sighteducation/vespa-activities-v2@main/staff/VESPAactivitiesStaff2b.css';
    ...
    window.initializeVESPAActivitiesStaff = function() {
        ...
        // Hide data views immediately (use your page's views)
        const viewsToHide = [CONFIG.views.vespaResults, CONFIG.views.studentRecords, CONFIG.views.activities, CONFIG.views.answers];
